    ...
    this.htmlElements = {
      huggins: {
        instruction: '<p class="notice">Now we will check your headphones.</p>' +
            ...
            '<p>On the next few pages, each page will have a button that plays an audio file. You can only play each audio once, so don\'t press the button until you are ready.</p>' +
            '<p>Each audio file contains a series of three noises. One of the noises has a faint beeping, chirping, or warbling sound hidden within.</p>' +
            '<p>Your task is to decide which of the three noises contains the hidden sound, and click on the correct button: <b>1</b>, <b>2</b>, or <b>3</b>.</p>' +
            '<p>Click the <span style="color:#03a9f4;"><b>blue</b></span> button below to play an example. The beeping, chirping, or warbling sound is hidden inside the second noise, so the answer is <b>2</b>.' +
        ...
        checkPage: '<p class="notice">Remember, you can only play each sound once. Please listen carefully.</p>' +
            '<p class="center">Which noise contains the hidden beeping, chirping, or warbling sound? Is it <b>1</b>, <b>2</b>, or <b>3</b>?</p>',
      },
      beat: {
        instruction: '<p class="notice">Now we will check your headphones.</p>' +
            '<p>We need to make sure that your headphones are adjusted and are functioning correctly.</p>' +
